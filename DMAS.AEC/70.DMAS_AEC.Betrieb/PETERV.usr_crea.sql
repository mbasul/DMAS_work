...
CREATE OR REPLACE USER PETERV -- adjust user name
    PASSWORD = 'PuhP7lzZOZ0WSHwOYua2' -- add a secure password
    LOGIN_NAME = 'PETERV' -- add a login name
    FIRST_NAME = 'Peter' -- add user's first name
    LAST_NAME = 'Vogel' -- add user's last name
    ...
    default_role = 'AOEC_USER'
    default_namespace = 'DMAS.AOEC_DMART'

    date_output_format = 'YYYY-MM-DD HH24:MI:SS'
